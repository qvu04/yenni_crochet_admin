...
export const VoucherFormSection = ({ title, children }: { title: string; children: ReactNode }) => (
...
interface VoucherToggleFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  label: string
}

export const VoucherToggleField = forwardRef<HTMLInputElement, VoucherToggleFieldProps>(({ label, ...props }, ref) => (
...
VoucherToggleField.displayName = 'VoucherToggleField'
